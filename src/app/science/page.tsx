...
import { fetchScienceHeadlines } from "@/_lib/api/api";
import { useQuery } from "@tanstack/react-query";
import { FaArrowRightLong } from "react-icons/fa6";
function page() {
  const { data, error, isLoading } = useQuery({
    queryKey: ["recentScience"],
    queryFn: fetchScienceHeadlines,
  });
  ...
  return (
    <section className="min-h-[300px] mt-10 p-4 max-w-[360px] lg:max-w-[1440px]  mx-auto">
      <h1 className="text-2xl underline mb-10">Science</h1>
